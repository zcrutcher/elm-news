...
*/
  ...
  var $author$project$Main$Response = F6(function (
    status,
    total_hits,
    page,
    total_pages,
  ...
  var $author$project$Main$Article = F9(function (
    title,
    published_date,
    link,
    clean_url,
  ...
  var $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom =
    $elm$json$Json$Decode$map2($elm$core$Basics$apR);
  ...
  var $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optionalDecoder =
    F3(function (pathDecoder, valDecoder, fallback) {
  ...
  var $author$project$Main$getArticles = function (searchTerm) {
    var requestHeader = _List_fromArray([
      A2(
        ...
        "x-api-key",
        "4sO4JEcX3HwMRR7yRvxAQAE67xRBVj__psUpcKmioNc"
      ),
    ]);
    return $elm$http$Http$request({
      ...
      expect: A2(
        ...
        $author$project$Main$GetArticles,
    ...
    switch (msg.$) {
      case "SearchTerm":
        ...
        return _Utils_Tuple2(
          _Utils_update(model, { searchTerm: searchTerm }),
          $elm$core$Platform$Cmd$none
        );
      case "GetArticles":
        if (msg.a.$ === "Ok") {
      ...
      default:
        return _Utils_Tuple2(
          _Utils_update(model, { response: model.response }),
  ...
  var $elm$html$Html$Attributes$name =
    $elm$html$Html$Attributes$stringProperty("name");
  ...
  var $author$project$Main$searchForm = A2(
    $elm$html$Html$div,
    _List_fromArray([$elm$html$Html$Attributes$class("search-wrapper")]),
    _List_fromArray([
      A2(
        $elm$html$Html$h3,
        _List_Nil,
        _List_fromArray([$elm$html$Html$text("testing this out")])
      ),
      A2(
        $elm$html$Html$form,
        _List_fromArray([
        ...
        _List_fromArray([
          ...
          A2(
            ...
            _List_fromArray([
              A2(
                $elm$html$Html$input,
                _List_fromArray([$elm$html$Html$Attributes$type_("submit")]),
                _List_Nil
              ),
            ])
          ),
  ...
  var $elm$html$Html$Attributes$target =
    $elm$html$Html$Attributes$stringProperty("target");
        ...
        A2(
          ...
          _List_fromArray([
            A2(
              ...
              _List_fromArray([$elm$html$Html$text(article.title)])
            ),
            A2(
              $elm$html$Html$span,
              _List_fromArray([
              ...
              _List_fromArray([$elm$html$Html$text(article.published_date)])
            ),
            A2(
              $elm$html$Html$img,
              _List_fromArray([
            ...
            A2(
              ...
              _List_fromArray([$elm$html$Html$text(article.excerpt)])
            ),
          ])
        ),
      ])
  ...
  var $author$project$Main$viewArticles = function (articles) {
    return A2(
      $elm$html$Html$div,
      _List_fromArray([$elm$html$Html$Attributes$class("article-wrapper")]),
    ...
    return A2(
      ...
      _List_fromArray([
        A2(
          $elm$html$Html$h1,
          _List_Nil,
          _List_fromArray([$elm$html$Html$text("Elm News Search")])
        ),
